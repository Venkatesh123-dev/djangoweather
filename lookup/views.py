...
def home(request):
    ...
    if request.method =="POST":
        ...
        api_request = requests.get("http://www.airnowapi.org/aq/observation/zipCode/current/?format=application/json&zipCode=" + zipcode + "&distance=5&API_KEY=8FBC7A30-AA69-4D99-B962-8ACF2403CC13")
        ...
        api_request = requests.get('http://www.airnowapi.org/aq/observation/zipCode/current/?format=application/json&zipCode=89129&distance=5&API_KEY=8FBC7A30-AA69-4D99-B962-8ACF2403CC13')
        try:
            api = json.loads(api_request.content)
        except Exception as e:
            api = "Error"    
